; ModuleID = 'memcpymemcpy_easy3.c'
source_filename = "memcpymemcpy_easy3.c"
...
if.else:                                          ; preds = %entry
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %8, i8* align 4 %10, i64 32, i1 false)
  %11 = load i32*, i32** %b.addr, align 8
  %12 = bitcast i32* %11 to i8*
  %13 = load i32*, i32** %a.addr, align 8
  %14 = bitcast i32* %13 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %12, i8* align 4 %14, i64 32, i1 false)
  %15 = load i32*, i32** %b.addr, align 8
  %arrayidx1 = getelementptr inbounds i32, i32* %15, i64 2
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %17, i8* align 4 %19, i64 32, i1 false)
  ret void
}
...
entry:
  ...
  %call = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), i32* %i)
  ...
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %10)
  %11 = load i32*, i32** %a, align 8
  %arrayidx6 = getelementptr inbounds i32, i32* %11, i64 4
  %12 = load i32, i32* %arrayidx6, align 4
  %call7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i32 %12)
  ret i32 0
}
